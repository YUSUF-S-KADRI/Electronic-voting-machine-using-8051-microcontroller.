...
// Control and Voting Pins
sbit ini_pin = P1^0;      // Start voting pin
sbit stop_pin = P1^5;     // Stop voting pin
sbit candidate_1 = P1^1;  // Candidate 1 Switch
sbit candidate_2 = P1^2;  // Candidate 2 Switch
sbit candidate_3 = P1^3;  // Candidate 3 Switch
sbit candidate_4 = P1^4;  // Candidate 4 Switch
...
// Function to display integer values (0-999) on the LCD
...
// Function to poll inputs and register votes
void vote_count() 
{
...
// LCD Initialization and Main UI flow
void lcd_ini()
{
    lcd_cmd(0x38);
    delay(msec);
...
// Function to calculate tallies and render results
void results() 
{
    int i;
    carry = 0;
...
// Main function managing state loop
void main()
{
    ini_pin = stop_pin = 1;
